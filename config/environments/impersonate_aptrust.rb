...
Rails.application.configure do
  ...
  config.salt = ENV['DPN_SALT'] || "impersonate_aptrust_salt"
  ...
  config.local_namespace = ENV['DPN_NAMESPACE'] || "aptrust"
  ...
  config.transfer_private_key = ENV['DPN_TRANSFER_PRIVATE_KEY'] || "~/.ssh/your_key_file_here.key"
end
