...
describe "shared/errors.json.erb" do
  before(:each) do
    allow(ActionController::Metal).to receive(:controller_name).and_return(ApiV1::BagsController.controller_name)
    allow(ActionController::Metal).to receive(:controller_path).and_return(ApiV1::BagsController.controller_path)
