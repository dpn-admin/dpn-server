...
ActiveRecord::Schema.define(version: 20150203202236) do

  create_table "fixity_algorithms", force: :cascade do |t|
    t.string   "name",       null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  add_index "fixity_algorithms", ["name"], name: "index_fixity_algorithms_on_name", unique: true

  create_table "nodes", force: :cascade do |t|
    t.string   "namespace",         null: false
    t.string   "readable_name",     null: false
    t.string   "ssh_pubkey"
    t.integer  "storage_region_id"
